...
import com.jmzd.ghazal.noteappmvvm.data.repository.MainRepository
import com.jmzd.ghazal.noteappmvvm.utils.DataStatus
...
class MainViewModel @Inject constructor(private val repository: MainRepository) : ViewModel() {
    ...
    /*حواستون باشه حتما روی ترد main کار کنید */
